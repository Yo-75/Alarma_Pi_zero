...
int oledInit(int iChannel, int iAddr, int iType, int bFlip, int bInvert)
{
	const unsigned char oled64_initbuf[] = {0x00, 0xae, 0xa8, 0x3f, 0xd3, 0x00, 0x40, 0xa1, 0xc8,
											0xda, 0x12, 0x81, 0xff, 0xa4, 0xa6, 0xd5, 0x80, 0x8d,
											0x14, 0xaf, 0x20, 0x02};

	const unsigned char oled32_initbuf[] = {0x00, 0xae, 0xd5, 0x80, 0xa8, 0x1f, 0xd3, 0x00, 0x40, 
											0x8d, 0x14, 0xa1, 0xc8, 0xda, 0x02,	0x81, 0x7f, 0xd9, 
	...
	{
		log_error("Failed to open i2c bus %d", iChannel);
		file_i2c = 0;
		return 1;
	}
	...
	{
		log_error("Failed to acquire bus access or talk to slave");
		file_i2c = 0;
		return 1;
	}
